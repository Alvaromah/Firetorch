...
valid_dl = torch.utils.data.DataLoader(valid_ds, batch_size=4, shuffle=False, num_workers=0)
...
metrics = model.train_epoch(train_dl, max_steps=100)
print(metrics.logs)

metrics = model.valid_epoch(valid_dl, max_steps=100)
print(metrics.logs)
